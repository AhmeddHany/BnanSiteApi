...
namespace BnanApi.Models
{
    public partial class BnanSCContext : IdentityDbContext<CrMasUserInformation>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.CrCasLessorWhatsupConnectId, e.CrCasLessorWhatsupConnectSerial })
                    .HasName("PK_CR_Cas_Lessor_Connect");
                ...
                entity.HasOne(d => d.CrCasLessorWhatsupConnectNavigation)
                    .WithMany(p => p.CrCasLessorWhatsupConnects)
                    .HasForeignKey(d => d.CrCasLessorWhatsupConnectId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
